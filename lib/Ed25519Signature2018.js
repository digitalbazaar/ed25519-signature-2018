...
const SUITE_CONTEXT_URL = ed25519Signature2018SuiteContext.constants.CONTEXT_URL;
...
export class Ed25519Signature2018 extends JwsLinkedDataSignature {
  ...
  async getVerificationMethod({proof, documentLoader}) {
    ...
    if(verificationMethod['@context'] === SUITE_CONTEXT_URL_2020 &&
      verificationMethod.type === 'Ed25519VerificationKey2020') {
        ...
        key2018.publicKeyBase58 = base58btc.encode(a._publicKeyBuffer);
